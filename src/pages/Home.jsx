          ...
          <div className="absolute inset-y-0 right-0 w-full md:w-1/2 flex items-center">
            <div className="px-6 sm:px-8 lg:px-10 py-8 md:py-0">
              ...
              <p className="mt-4 text-gray-700 text-sm md:text-base max-w-xl leading-relaxed">
                ...
                fair prices. From small fixes to big installations, we’ve got
                your home covered.
              </p>
...
const AboutBand = () => {
  return (
    <section className="py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative mx-auto max-w-6xl rounded-[36px] bg-white ring-1 ring-black/5 overflow-hidden">
            ...
            <div className="relative h-[520px] md:h-[560px] rounded-[28px] overflow-hidden bg-white">
              <img
                ...
                className="
                  ...
                  h-full w-[92%] sm:w-[80%] md:w-[62%] lg:w-[58%]
                  object-cover
                "
              />
              ...
              >
                ...
                <Link
                  to="/about"
                  className="
                    mt-4 md:mt-6 inline-flex items-center gap-2
                    rounded-xl border border-gray-300 bg-white
                    hover:bg-black hover:text-white
                    px-4 py-2.5 font-semibold text-gray-900
                    transition-all duration-300 ease-in-out
